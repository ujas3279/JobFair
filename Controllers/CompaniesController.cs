...
namespace JobFair.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Companies.Include(c => c.Register);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cid,CompanyName,HiringDate,Description,Criteria,Vacancies,Package,ApplyLink,Rid")] Company company)
        {
            if (id != company.Cid)
            {
                return NotFound();
        ...
        {
            return _context.Companies.Any(e => e.Cid == id);
        }
    }
}
